...
# 
# B1Z1 Ring Slope Configuration

from legged_gym.envs.base.legged_robot_config import LeggedRobotCfg, LeggedRobotCfgPPO
import numpy as np

class B1Z1RingSlopeCfg( LeggedRobotCfg ):
    """
    Configuration class for the B1Z1 robot with ring slope climbing.
    """
    class goal_ee:
        num_commands = 3
        traj_time = [1, 3]
    ...
    class init_state( LeggedRobotCfg.init_state ):
        ...
        rand_yaw_range = np.pi 
        origin_perturb_range = 0.3  
    ...
    class terrain:
        ...
        terrain_dict = {"smooth slope": 0., 
                        ...
                        "pit": 0.0,
                        "wall": 0.0,
                        "random stairs up": 0.0,
                        "ring_slope": 1.0}
        terrain_proportions = list(terrain_dict.values())
        
        slope_angle = [0.05, 0.35]
        platform_size = 5.0
        slope_height = [2.0, 8.0]
...
class B1Z1RingSlopeCfgPPO(LeggedRobotCfgPPO):
    seed = 1
    ...
    class policy:
        ...
        adaptive_arm_gains = B1Z1RingSlopeCfg.control.adaptive_arm_gains
    ...
    class algorithm:
        ...
        torque_supervision = B1Z1RingSlopeCfg.control.torque_supervision  
    ...
    class runner:
        ...
        experiment_name = 'b1z1_ring_slope'
        run_name = ''
        # load and resume
        resume = False
